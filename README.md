...
GitHub Pages deployment for **DA BOYZ Draft Assistant v0.12.4**.

This repository hosts the Android/PWA deployment candidate. The football model and 331-player pool remain byte-bound to the validated v0.12.4 payload; this release carries the approved soft RB-WR balance calibration plus safe hosted-update delivery, cache safety, install metadata, and regression coverage.
