...
const CACHE='daboyz-draft-assistant-v0.13.1-draft-day-1';
const INDEX=new URL('./index.html',self.registration.scope).href;
const ASSETS=['./','./index.html','./app.html.gz','./version.json','./manifest.webmanifest','./icon-192.png','./icon-512.png','./icon-192.svg','./icon-512.svg','./simulation-calibration.js','./draft-day-overlay.js','./interpretation-layer.js','./affinity-tracker.js','./archive-config.js','./archive-client.js','./mock-toolbar.js'];
